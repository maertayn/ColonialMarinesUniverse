...
public sealed partial class TestPair
{
    ...
    {
        var reconnect = TestMap != null && Client.NetMan.IsConnected && Settings.Connected;
        if (TestMap != null && Client.NetMan.IsConnected)
            await Disconnect("Test map cleanup disconnect");
